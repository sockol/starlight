...
function facade(){
	...
	if ($query->have_posts()) : 
		while ($query->have_posts()) : 
			...
			if(get_the_title() == $param) 
				$models_array = get_field('models_facades');
	...
	include(get_template_directory().'/templates/quote/quote-facade.php');
    exit();
}

// creating Ajax call for WordPress  
add_action('wp_ajax_nopriv_facade', 'facade');
add_action('wp_ajax_facade', 'facade');
